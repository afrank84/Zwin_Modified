            ...
            <section id="content" >
                ...
                <section id="contact">
                    ...
                    <div class="contact-form">
                        ...
                        <form action="http://formspree.io/anthonyfrank@live.com" id="contactform">
                            <p>
					...
					-->
						<form class="form-horizontal" role="form" method="post" action="index.php">
							...
							<div class="form-group"> 
								...
								<div class="col-sm-10">
									<input type="email" class="input" id="email" name="email" placeholder="example@domain.com" value="<?php echo htmlspecialchars($_POST['email']); ?>">
